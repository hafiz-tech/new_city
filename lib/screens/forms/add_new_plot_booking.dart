...
class AddNewPlotBooking extends StatefulWidget {
  @override
  _AddNewPlotBookingState createState() => _AddNewPlotBookingState();
}

class _AddNewPlotBookingState extends State<AddNewPlotBooking> {
  ...
  List<String> items3 = ['5465454654 Ali', '5465454654 Test', '5465454654 QA'];
